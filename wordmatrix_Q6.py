...
def train(message, ls, pos_test, neg_test, pr_yi_pos_train, pr_yi_neg_train, freq_pos_train, freq_neg_train,
    ...
    for instance in pos_test:
        ...
        if pos_pr > neg_pr:
            ...
            predicted_class.append(random.choice([0, 1]))
        else:
...
def naive_bayes():
    percentage_positive_instances_train = 0.1000
    percentage_negative_instances_train = 0.5000
